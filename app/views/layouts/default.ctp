...
<div id="main">
	...
	<div id="cols" class="box">
		...
		<div id="aside" class="box">
			...
			<div class="padding box">
				...
				<div id="logo"><?=$html->link($html->image('logo.gif'), '/', array('escape' => false), null, false);?></div>
	...
	<div id="footer" class="box">
		...
		<p class="f-right"><?php echo $html->link($html->image('afzetinc.png'), 'http://afzetinc.com', array('escape' => false, 'target' => 'new'))?></p>
